...
public class Action_SaveAsObject {
	...
	public static void main(String[] args) throws Exception {
		...
		//distData.foreach(s -> System.out.println(s));

		distData.saveAsObjectFile("C:/scala-workspace/edu-test-file_1");
		ctx.objectFile("C:/scala-workspace/edu-test-file_1");
