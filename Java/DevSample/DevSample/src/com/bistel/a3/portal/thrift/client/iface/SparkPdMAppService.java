...
public class SparkPdMAppService {

  public interface Iface {

    public SparkPdMResponse run(SparkPdMRequest request) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void run(SparkPdMRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_run(SparkPdMRequest request) throws org.apache.thrift.TException
    {
    ...
    public SparkPdMResponse recv_run() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class run_call extends org.apache.thrift.async.TAsyncMethodCall {
      private SparkPdMRequest request;
      public run_call(SparkPdMRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public SparkPdMResponse getResult() throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class run<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, run_args, SparkPdMResponse> {
      public run() {
        super("run");
      }
      ...
      public AsyncMethodCallback<SparkPdMResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<SparkPdMResponse>() { 
          public void onComplete(SparkPdMResponse o) {
            run_result result = new run_result();
            result.success = o;
            try {
      ...
      public void start(I iface, run_args args, org.apache.thrift.async.AsyncMethodCallback<SparkPdMResponse> resultHandler) throws TException {
  ...
  public static class run_args implements org.apache.thrift.TBase<run_args, run_args._Fields>, java.io.Serializable, Cloneable, Comparable<run_args>   {
    ...
    public SparkPdMRequest request; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.REQUEST, new org.apache.thrift.meta_data.FieldMetaData("request", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, SparkPdMRequest.class)));
    ...
    public run_args(run_args other) {
      if (other.isSetRequest()) {
        this.request = new SparkPdMRequest(other.request);
      }
    }
    ...
    public SparkPdMRequest getRequest() {
      return this.request;
    }

    public run_args setRequest(SparkPdMRequest request) {
      this.request = request;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUEST:
        if (value == null) {
          ...
          setRequest((SparkPdMRequest)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 1: // REQUEST
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.request = new SparkPdMRequest();
  ...
  public static class run_result implements org.apache.thrift.TBase<run_result, run_result._Fields>, java.io.Serializable, Cloneable, Comparable<run_result>   {
    ...
    public SparkPdMResponse success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, SparkPdMResponse.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public run_result(run_result other) {
      if (other.isSetSuccess()) {
        this.success = new SparkPdMResponse(other.success);
      }
    }
    ...
    public SparkPdMResponse getSuccess() {
      return this.success;
    }

    public run_result setSuccess(SparkPdMResponse success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((SparkPdMResponse)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, run_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new SparkPdMResponse();
