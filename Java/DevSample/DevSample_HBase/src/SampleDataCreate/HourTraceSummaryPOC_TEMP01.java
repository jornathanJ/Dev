...
public class HourTraceSummaryPOC_TEMP01 {
...
//				p.addColumn(COLUMN_FAMILY, COL_MEAN, Bytes.toBytes(String.format("%f", _mean.mean_data[loop+initPosition])));
				...
				p.addColumn(COLUMN_FAMILY, COL_MIN, Bytes.toBytes(String.format("%f", temp01.min[loop+initPosition])));
				p.addColumn(COLUMN_FAMILY, COL_MAX, Bytes.toBytes(String.format("%f", temp01.max[loop+initPosition])));
				p.addColumn(COLUMN_FAMILY, COL_STD, Bytes.toBytes(String.format("%f", temp01.std[loop+initPosition])));
				p.addColumn(COLUMN_FAMILY, COL_MEAN, Bytes.toBytes(String.format("%f", temp01.mean[loop+initPosition])));
...
//								,_mean.mean_data[loop+initPosition]));
				...
				System.out.println(String.format("%s  [%f, %f, %f, %f]", strOutString
						, temp01.min[loop+initPosition]
								, temp01.max[loop+initPosition]
								, temp01.std[loop+initPosition]
								,temp01.mean[loop+initPosition]));
